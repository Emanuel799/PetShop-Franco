let data = {
    ...
    "descripcion":"Esta pelota estimula el pensamiento de su mascota haciendo que tenga que encontrar la forma de jugar con ella para poder recibir su premio. Puede ser utilizada tanto por perros como por gatos y favorece el tiempo de ingesta para mejorar la digestión de los mismos",
    "precio":970,
    "stock":4,
    ...
    {
    "_id":"5f205439bf2ede0017e48509",
    "nombre":"Frisbee de silicona",
    "descripcion":"Excelente juguete para hacer que su perro haga más ejercicio y libere tensiones. Ayuda a mantenerlo activo y de esa manera se mantendrá alejado de los muebles. Al ser de silicona de primer nivel, puede ser utilizado al aire libre aunque también como mordillo dentro de la casa.",
    "precio":320,
    "stock":20,
    ...
    {
    "_id":"5f205452bf2ede0017e4850a",
    "nombre":"Pelota de agua con compartimento",
    "descripcion":"Hecha con el mejor de los materiales, esta pelota se llena de agua y tiene un compartimento para que se pueda insertar algo de comida o interes para el animal. Está recomendada para perros pequeños sin mordida pesada. Tiene 8cm de diametro.",
    "precio":500,
    "stock":2,
    ...
    {
    "_id":"5f205469bf2ede0017e4850c",
    "nombre":"Pelota con sopapa",
    "descripcion":"Hecho con excelentes y duraderos materiales, es un juguete muy versátil. La sopapa permite que sea amurado a cualquier superfice lisa lo que permite que esté en una puerta, el piso, una ventana, etc. aunque muchos a perros les divierte usarla sin que esté amurada por sus cuerdas y la pelota en la punta opuesta a la sopapa",
    "precio":380,
    "stock":3,
    ...
    {
    "_id":"5f205481bf2ede0017e4850d",
    "nombre":"Botella bebedero portatil",
    "descripcion":"Con una tapa con un cuenco es ideal para las caminatas largas o en dias calurosos. Uno libera el agua y pone el cuenco a disposición de su mascota para que se hidrate y siga el camino. Viene en varios colores, consultar previamente",
    "precio":840,
    "stock":9,
    ...
    {
        "_id":"5f205488bf2ede0017e4850e",
    "nombre":"Juguete Jigwy Gladiador Azul - Mediano",
    "descripcion":"Peluche ideal para que su perro se divierta en compañia de nuestro gadiador favorito. Listo para cualquier juego el podrá acompañar a su mascota hasta el cansancio",
    "precio":940,
    "stock":6,
    ...
    {
    "_id":"5f20f53a54c7bc0017856c7f",
    "nombre":"Antipulgas Y Garrapatas Bravecto Para Perros",
    "descripcion":"Producto especializado para perros de pequeños. Uso veterinario.",
    "precio":1290,
    "stock":12,
    ...
    {
    "_id":"5f20f54254c7bc0017856c80",
    "nombre":"Antiparasitario Interno Total Full CG Perros - 15 Cc",
    "descripcion":"Antiparasitario interno en suspensión oral, contiene Fenbendazol y Toltrazuril. Uso veterinario.",
    "precio":350,
    "stock":2,
    ...
    {
    "_id":"5f20f54c54c7bc0017856c81",
    "nombre":"FRONTLINE Spray - 100 ml",
    "descripcion":"Antiparasitario externo. Es un producto de gran eficacia para controlar pulgas, garrapatas y piojos en perros y gatos. Desde los dos días de edad. Contiene Fipronil.",
    "precio":1190,
    "stock":2,
    ...
    {
    "_id":"5f20f55554c7bc0017856c82",
    "nombre":"Total Full Cachorro Suspension - 15 Cc",
    "descripcion":"Antiparasitario interno en suspensión oral. Estuche con frasco con 15 ml y jeringa dosificadora. Contiene Fenbendazol y Pirantel.",
    "precio":240,
    "stock":10,
    ...
    {
    "_id":"5f20f55b54c7bc0017856c83",
    "nombre":"Comfortis Tableta 560 Mg - 9-18 Kg",
    "descripcion":"Comfortis con spinosad de Elanco Lilly es una tableta via oral con sabor a carne que mata las pulgas de su perro. Proporciona un mes completo de protección de la pulga para ayudar a prevenir futuras infestaciones de pulgas.",
    "precio":610,
    "stock":8,
    ...
    {
    "_id":"5f20f56f54c7bc0017856c85",
    "nombre":"Collar Antipulgas Ecthol Para Perros - 63 Cm",
    "descripcion":"Collar con antiparasitario externo para el control de pulgas y garrapatas. Antiparasitario externo a base de Clorpirifos, organofosforado que actúa por tensión de vapor con acción larvicida y adulticida",
    "precio":329,
    "stock":9,
